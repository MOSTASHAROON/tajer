...
Sell any kind of digital goods: downloads, articles,  a piece of content or any kind of content or virtual products
...
* Bundles: creating bundles with Tajer is very easy, just a few clicks. You can sell your products in bundles so your customers will have so many choices.
* Coupons: you can offer discounts with coupons for your customers, you can easily create complex coupons because Tajer contains a lot of settings that you can set.
* PayPal: bundled with the most well noun PayPal payment gateway.
...
* Add-ons: extend Tajer functionalities with [add-ons](https://mostasharoon.org/tajer-add-ons/)!
...
1. [Tajer Main Page](https://mostasharoon.org/tajer/)
2. [Documentation](https://mostasharoon.org/tajer-documentation/)
3. [Add-ons](https://mostasharoon.org/tajer-add-ons/)
4. [Demo](https://demo.mostasharoon.org/tajer/)
5. [Our main website that powered by Tajer](https://mostasharoon.org)

== Installation ==

Please see the [quick start guide](https://mostasharoon.org/tajer-documentation/quick-start-guide/) and [requirements & tested with](https://mostasharoon.org/tajer-documentation/requirements-tested-with/) subjects.

== Frequently Asked Questions ==

Please visit [Tajer FAQs page](https://mostasharoon.org/tajer-documentation/tajer-faqs/).

== Screenshots ==

1. Cart/Checkout screen
2. Frontend user dashboard(user products)
3. Tajer general settings
4. Tajer payment gateways settings
5. Tajer emails settings
6. Tajer taxes settings
7. Tajer tools settings
8. Product configurations
9. Product preview with the default pricing style
10. Product preview with the default pricing widget style
11. Coupon configurations
...
* New: Adding new functions.
* Fix: Fix frontend dashboard download limits issue.

= 1.0.3, February 3, 2016 =

* New: Nigerian Naira currency.

= 1.0.2, February 2, 2016 =

* Fix: CSS fields height issue in cart page only in Firefox browser.
